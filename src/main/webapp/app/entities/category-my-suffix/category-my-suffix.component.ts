...
export class CategoryMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.categoryService
            ...
            .subscribe(
                (res: HttpResponse<ICategoryMySuffix[]>) => this.paginateCategories(res.body, res.headers),
    ...
    trackId(index: number, item: ICategoryMySuffix) {
        return item.id;
    }
    ...
    private paginateCategories(data: ICategoryMySuffix[], headers: HttpHeaders) {
