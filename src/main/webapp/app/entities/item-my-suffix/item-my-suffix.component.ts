...
export class ItemMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.itemService
            ...
            .subscribe(
                (res: HttpResponse<IItemMySuffix[]>) => this.paginateItems(res.body, res.headers),
    ...
    trackId(index: number, item: IItemMySuffix) {
        return item.id;
    }
    ...
    private paginateItems(data: IItemMySuffix[], headers: HttpHeaders) {
