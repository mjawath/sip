...
export class SalesOrderComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.salesOrderService
            ...
            .subscribe(
                (res: HttpResponse<ISalesOrder[]>) => this.paginateSalesOrders(res.body, res.headers),
    ...
    trackId(index: number, item: ISalesOrder) {
        return item.id;
    }
    ...
    private paginateSalesOrders(data: ISalesOrder[], headers: HttpHeaders) {
