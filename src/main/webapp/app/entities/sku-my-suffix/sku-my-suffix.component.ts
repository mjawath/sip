...
export class SKUMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.sKUService
            ...
            .subscribe(
                (res: HttpResponse<ISKUMySuffix[]>) => this.paginateSKUS(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/sku-my-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ISKUMySuffix) {
        return item.id;
    }
    ...
    private paginateSKUS(data: ISKUMySuffix[], headers: HttpHeaders) {
