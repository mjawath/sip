...
import { SalesOrderLineComponent } from 'app/entities/sales-order-line/sales-order-line.component';
...
describe('Component Tests', () => {
    describe('SalesOrderLine Management Component', () => {
        let comp: SalesOrderLineComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SalesOrderLineComponent, '')
                .compileComponents();
